<template>
    <div class="w-[90%] mx-[5%] flex-1 border-2 bg-red-500/70 hover:bg-red-500 transition-all ease-in-out duration-200 rounded-2xl p-[1%] flex justify-center items-center"
    ...
    <div class="w-[90%] mx-[5%] flex-1 border-2 bg-emerald-500/70 hover:bg-emerald-500 transition-all ease-in-out duration-200 rounded-2xl p-[1%] flex justify-center items-center"
    ...
    <div class="w-[90%] mx-[5%] h-full border-2 transition-all ease-in-out duration-200 rounded-2xl p-[1%] flex flex-col justify-around items-center text-xl elms-sans"
        ...
        hover:translate-y-[-5%] active:translate-y-[5%] py-[1%] elms-sans text-2x"
            ...
            @click="$emit('testFinish', reactionScore, earlyCall)">GO TO NEXT TEST / FINISH</button>
    </div>
    <div class="w-[90%] mx-[5%] h-full border-2 transition-all ease-in-out duration-200 rounded-2xl p-[1%] flex flex-col justify-around items-center elms-sans text-xl"
